...
def waypoint_assignment():
    ...
    while not rospy.is_shutdown():
        ...
        if enable is True:
            ...
            my_candidate   = int(waypoint_orderd[0][0])
            ...
            for i in range(len(other_id)):
                ...
                other_dist = service_call[other_id[i]](my_candidate).distance
                # Salvo la distanza nel dizionario SERVE VERAMENTE UN DIZIONARIO ANCHE QUI?
                # IN TEORIA NO, MI BASTA CONOSCERE LE DISTANZE DEGLI ALTRI ROBOT, SENZA SAPERE 
                # I LORO ID.
